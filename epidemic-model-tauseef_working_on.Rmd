...
socialnetwork <- makeNetwork(5,numsets=1,power=.59,steps=1)
print(socialnetwork)
#socialnetwork <- addAgentToNetwork(5,numsets=3,power=.59,steps=1)
```
```{r}
 # socialnetwork <- addAgentToNetwork(numAgents = 1,prev_network = socialnetwork,
 #                                    connection_number = 1,self_connected=0)
 # print(socialnetwork)


#cc <- gplot(socialnetwork,edge.col="black")
```
...
###First Part of the simulations (No locals are affected with a strain from beginning)
...
###Travel ban is implemented from Day 7 and removed early (In this case from day 49). Each traveler will have only three connections with local agents
...
###Travel ban is implemented from Day 7 and removed early (In this case from day 49). Each traveler will have only one connection with local agents
...
###Travel ban is implemented from Day 7 and removed later (In this case from day 80). Each traveler will have only three connection with local agents
...
###Travel ban is implemented from Day 7 and removed later (In this case from day 80). Each traveler will have only one connection with local agent
...
###Second Part of the simulations (some locals are affected with a strain from beginning)
...
###Travel ban is implemented from Day 7 and removed later. Each traveler will have only three connection with local agents
...
###Travel ban is implemented from Day 7 and removed later (In this case from day 80). Each traveler will have only one connection with local agents
